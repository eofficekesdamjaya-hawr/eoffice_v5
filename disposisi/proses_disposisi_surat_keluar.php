...
?>
root@srv443898:/var/www/eoffice_kesdamjayav5# mysql -u root -p
Enter password: 
Welcome to the MySQL monitor.  Commands end with ; or \g.
Your MySQL connection id is 22595
...
mysql> USE eoffice_kesdamjayav5;
Reading table information for completion of table and column names
You can turn off this feature to get a quicker startup with -A

Database changed
mysql> DESCRIBE notifikasi;
+-------------+-----------------------+------+-----+-------------------+-------------------+
| Field       | Type                  | Null | Key | Default           | Extra             |
+-------------+-----------------------+------+-----+-------------------+-------------------+
| id_notif    | int                   | NO   | PRI | NULL              | auto_increment    |
| id_surat    | int                   | YES  |     | NULL              |                   |
| untuk_role  | varchar(100)          | YES  |     | NULL              |                   |
| dari_role   | varchar(100)          | YES  |     | NULL              |                   |
| pesan       | text                  | YES  |     | NULL              |                   |
| link        | varchar(255)          | YES  |     | NULL              |                   |
| status_baca | enum('belum','sudah') | YES  |     | belum             |                   |
| tanggal     | datetime              | YES  |     | CURRENT_TIMESTAMP | DEFAULT_GENERATED |
+-------------+-----------------------+------+-----+-------------------+-------------------+
8 rows in set (0.01 sec)

mysql> exit;
Bye
root@srv443898:/var/www/eoffice_kesdamjayav5# cat /var/www/eoffice_kesdamjayav5/disposisi/proses_disposisi_surat_keluar.php
<?php
if (session_status() === PHP_SESSION_NONE) {
    session_start();
}
