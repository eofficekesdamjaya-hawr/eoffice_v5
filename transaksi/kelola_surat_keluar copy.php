...
<td>
    <div class="d-flex flex-column gap-1">
        ...
        ?>
            ...
            <div class="dropdown">
                <button class="btn btn-outline-secondary btn-sm dropdown-toggle w-100 text-xs" type="button" data-bs-toggle="dropdown" data-bs-pointer-type="mouse" aria-expanded="false">Menu Lainnya</button>
